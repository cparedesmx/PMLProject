...
The model trained above was used to predict the 20 cases in the validation dataset. The values below were validated with an accuracy of 1.0000 when submitted, confirming the validity of the model.
